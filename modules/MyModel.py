...
if __name__ == '__main__':
    ...
    # print(arch_cfg)
    model = MyMOSModel(nclasses=3, movable_nclasses=3, params=arch_cfg, num_batch=1)
    # print(model)
